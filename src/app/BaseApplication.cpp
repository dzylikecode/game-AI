...
BaseApplication::BaseApplication(const String& applicationTitle,
                                 const int width, const int height)
    : m_applicationTitle(applicationTitle), m_width(width), m_height(height) {}
...
bool BaseApplication::setup() {
  InitWindow(m_width, m_height, m_applicationTitle.c_str());
  SetTargetFPS(60);
  return true;
}

void BaseApplication::close() { CloseWindow(); }
...
//   Ogre::WindowEventUtilities::removeWindowEventListener(renderWindow_,
//   this);
...
//   ***"); OIS::ParamList pl; size_t windowHnd = 0; std::ostringstream
//   windowHndStr;
...
//   Ogre::WindowEventUtilities::addWindowEventListener(renderWindow_,
//   this);
...
// {
//   if (shutdown_ || renderWindow_->isClosed()) return false;
...
// Ogre::Camera* BaseApplication::GetCamera() { return camera_; }

// Ogre::RenderWindow* BaseApplication::GetRenderWindow() { return
// renderWindow_; }

// Ogre::SceneManager* BaseApplication::GetSceneManager() { return
// sceneManager_; }

// void BaseApplication::HandleKeyPress(const OIS::KeyCode keycode,
//                                      unsigned int key) {
//   (void)keycode;
//   (void)key;
// }

// void BaseApplication::HandleKeyRelease(const OIS::KeyCode keycode,
//                                        unsigned int key) {
//   (void)keycode;
//   (void)key;
// }
...
// void BaseApplication::HandleMousePress(const int width, const int height,
...
// void BaseApplication::HandleMouseRelease(const int width, const int
// height,
//                                          const OIS::MouseButtonID button)
//                                          {
//   (void)width;
...
// bool BaseApplication::mousePressed(const OIS::MouseEvent& event,
...
// bool BaseApplication::mouseReleased(const OIS::MouseEvent& event,
//                                     OIS::MouseButtonID id) {
...
// void BaseApplication::SetShutdown(const bool shutdown) { shutdown_ =
// shutdown; }

// bool BaseApplication::Setup(void) {
// #ifdef _DEBUG
//   root_ = new Ogre::Root("", APPLICATION_CONFIG_DEBUG,
//   APPLICATION_LOG_DEBUG);
// #else
//   root_ =
//       new Ogre::Root("", APPLICATION_CONFIG_RELEASE,
//       APPLICATION_LOG_RELEASE);
// #endif
...
//   // Only close for window that created OIS (the main window in these
//   demos) if (renderWindow == renderWindow_) {
//     if (inputManager_) {
